...
import Package from "../../../components/FindProfessional/Package.jsx";
...
const FindProfessionals = (props) => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto">
      ...
      <Package packages={props.orgData.packages || []} />
      <Footer />
    </div>
  );
};
...
// 	let data;
// 	try {
// 		data = await axios.get(`/view/organizations/${slug}/package`);
...
// 	}
// 	return {
// 		props: { packages: data.data.data }, // will be passed to the page component as props
// 	};
// }
export async function getServerSideProps(ctx) {
  const { slug } = ctx.params;
