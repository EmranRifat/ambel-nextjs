        ...
        <div className="w-full flex flex-col items-center bg-white rounded-md">
          <div className="w-full flex flex-col items-center">
            <div className="w-full flex justify-end items-center px-2">
              <MdClear
                onClick={() => props.setConflict(false)}
                className="text-xl text-[#5B5B5BB2] cursor-pointer"
              />
            </div>
            <span className="text-[16px] text-[#5B5B5B]">
              This schedule is conflict with another schedule
            </span>
          </div>
          <span className="text-[10px] text-[#5B5B5B]">
            20 january, 2022; 9:00 to 10:30 AM with{" "}
            <span className="text-[#0089C9]">Delware Hossain</span> for service
            name
          </span>
          ...
          <div className="w-full flex justify-between">
            ...
            <div className="flex justify-start items-center mr-4 mt-2">
          ...
          >
            ...
            <div className="flex items-center mt-6">
              <button
                onClick={() => props.setConflict(false)}
                className="h-[24px] w-[72px] rounded-lg bg-[#D9D9D9] text-black text-[14px] mr-2"
              >
                Cancel
              </button>
              <button className="h-[24px] w-[72px] rounded-lg bg-[#19525A] text-[14px] text-white">
                Save
              </button>
            </div>
          </div>
