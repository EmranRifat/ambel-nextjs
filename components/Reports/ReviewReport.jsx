...
import ReviewReportInfo from "./ReviewReportInfo";
              ...
              <tbody className="w-full">
                {ReviewReportInfo.map((info) => (
                  <tr key={info.id} className="border-b-2">
                    ...
                    <td className="text-sm text-center p-3 py-[14px] w-[200px] text-[#5b5b5b]">
                      {info.description}
                    </td>
                  </tr>
                ))}
