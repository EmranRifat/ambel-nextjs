    ...
    <React.Fragment>
      <div className="flex justify-start rounded-[4px]">
        <button
          ...
          className="text-gray-600 mx-4 my-atuo bg-white text-base focus:ring-2 focus:outline-none focus:ring-sky-500 rounded-[8px] border-[0.5px] border-[#19525A80] w-[120px] h-[32px]   text-center inline-flex items-center"
          type="button"
        >
          <div className="mx-2 flex justify-between">
            <p className="text-[14px] my-auto text-[#5b5b5b]">Case</p>
            <svg
