...
export default function RefundedFrndModal({ visible, onClose }) {
        ...
        <div>
          ...
          <div className="bg-white p-4 mt-4 rounded-[8px] w-[900px] ">
            ...
            <div className="text-center -mt-[120px]">
              <div className="my-2">
                <p className="text-white text-[14px] mb-1">Refunded A Friend</p>
              ...
              <div className="flex ">
                ...
                <div className="w-2/4 px-[50px] py-4  text-left">
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <p className="text-base text-[#5b5b5b]">Balance</p>
                  </div>
                </div>
                {/* 2nd column  */}
                <div className="w-2/4 px-[50px] py-4  text-left">
                  <div className="flex justify-between py-2">
                    ...
                    <p className="text-base text-[#5b5b5b]">Delware</p>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-[#19525AB2] font-medium">
                      Address :
                  ...
                  <div className="flex justify-between py-2">
                    <span className="text-[#19525AB2] font-medium">Paid :</span>
                    <p className="text-base text-[#5b5b5b] ">$500.00 USD</p>
                  </div>
                </div>
              </div>
