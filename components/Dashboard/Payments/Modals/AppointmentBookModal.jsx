...
export default function AppointmentBookModal({ visible, onClose }) {
        ...
        <div>
          ...
          <div className="bg-white p-4 mt-4 rounded-[8px] w-[900px] ">
            ...
            <div className="text-center -mt-[120px]">
              <div className="my-2 ">
                <p className="text-white text-[14px] mb-1">Appointment book</p>
              ...
              <div className="flex ">
                <div className="w-2/4 px-[50px] py-4  text-left">
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <p className="text-base text-[#5b5b5b]"> Cash</p>
                  </div>
                </div>
                <div className="w-2/4 px-[50px] py-4  text-left">
                  <div className="flex justify-between py-2">
              ...
              <button className="flex mx-auto rounded-lg py-2 px-[70px] bg-[#19525A] text-white mt-[10px] mb-[10px]">
