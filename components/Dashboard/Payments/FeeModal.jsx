...
import { finesCreate, getFines } from "../../../store/actions/fines";
              ...
              <div className="w-full flex flex-col justify-center items-center p-3">
                  ...
                  <div className="w-full flex justify-center">
                    <MultiSelectDropdown
                      ...
                      onSelectedItem={(selected) => {
                        if (selected === "-1") {
                          if (
                            fines.practitioners.length !== practitioners.length
                          ) {
                ...
                <div className="w-full flex justify-end items-end px-3 py-5">
                  ...
                  <button
                    ...
                    onClick={() => {
                      props.finesCreate(fines).then((res) => {
                        props.getFines();
                        setShowModal(false);
                      });
                    }}
