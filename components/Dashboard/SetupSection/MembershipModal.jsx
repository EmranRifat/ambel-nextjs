...
const MembershipModal = (props) => {
  ...
  const onChangeValue = (event) => {
    ...
    if (name === "name") setMemberShipValue(value.length);
  ...
  return (
    <>
      <button
        className="text-[20px] w-[206px] h-[40px] bg-[#19525A] text-white rounded-[10px]"
        type="button"
          ...
          <div className="justify-center items-center flex absolute overflow-y-scroll h-[100vh] inset-0 z-50 bg-[#63636347] outline-none focus:outline-none">
            <div className="max-w-[580px] lg:min-w-[665px] absolute left-[30%] top-10 flex flex-col items-center bg-white rounded-md border-b-2">
              ...
              <div className="flex w-full justify-center border-b-2 border-gray-300 pb-5">
                <span className="text-[#19525A] text-[32px] font-[700] mt-2">
              ...
              <div className="flex w-full justify-between items-center px-[23px] py-3 border-b-[2px] border-gray-300">
                ...
                <div>
                  <div
                    className={`flex w-[240px] border-[0.5px] border-[#1A535B] rounded-[8px] ml-auto ${parseFloat(memberShipValue) > 60 &&
                  ...
                  >
                    <input
                      ...
                      className="outline-none w-[210px] rounded-[8px] py-2 pl-2"
                    />
                    <p className="w-[35px] mt-auto text-xs text-gray-300">
                      {memberShipValue === "" ? (
                        <span>00</span>
                      ) : (
                        <span>{memberShipValue}</span>
                      )}
                      /60
                    </p>
                  </div>
                  <div>
                    {parseFloat(memberShipValue) > 60 && (
                ...
                <div>
                  ...
                  >
                    <textarea
                      ...
                      onChange={onChangeValue}
                      className="outline-none w-[230px] h-[77px] rounded-[8px] py-1 px-2"
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-[2px] border-gray-300">
                <p className="text-[16px] text-[#5B5B5B] flex">
                  Price<span className="text-rose-600 flex">*
                    <Tooltip
                      position="top"
                      content="Specify the timing of billing for this membership 
                      as well as the cost per billing cycle. (e.g., $500 
                      per week)"
                    >
                ...
                <div className="flex w-[270px] gap-2">
                  <div className="flex items-center text-center border-[0.5px] border-[#1A535B] rounded-[8px] w-[140px] overflow-hidden">
                    <span className="h-[36px] w-[40px] bg-[#00A455] text-center text-[24px] text-white rounded-l-[8px]">
                      $
                    </span>
                    <input
                      type="number"
                      ...
                      onChange={onChangeValue}
                      className="outline-none rounded-[8px] py-2 px-1 h-[36px] w-[100px]"
                    />
                  </div>
                  <div className="w-[120px] flex justify-center border-[0.5px] border-[#1A535B] rounded-[8px] ">
                    <Dropdown
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-[2px] border-gray-300">
                <p className="text-[16px] text-[#5B5B5B] flex">
                  ...
                  <Tooltip
                    position="top"
                    content="Specifies how long a membership will be active. 
                    This membership's billing cycle will involve 
                    repeated invoices right up until the due date. 
                    (e.g., $100 per week for 6 weeks)"
                  >
                    <RiErrorWarningLine className="text-xs text-[#1A535B] -mt-[7px] -ml-[4px]" />
                  </Tooltip>
                </p>
                <div className="flex items-center text-center border-[0.5px] border-[#1A535B] rounded-[8px] overflow-hidden">
                  <input
                    ...
                    onChange={onChangeValue}
                    className="outline-none rounded-l-[8px] h-[36px] ml-2 py-2 px-1 w-[121px]"
                  />
                  <div className="h-[36px] w-[119px] bg-[#D98829] text-center text-[16px] text-white rounded-r-md flex items-center justify-center">
                    Days
                  </div>
                </div>
              </div>
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-[2px] border-gray-300">
                <span className="text-[16px] text-[#5B5B5B] flex">
                  ...
                  <Tooltip
                    position="top"
                    content="That determines your membership, which will be 
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-[2px] border-gray-300">
                <span className="text-[16px] text-[#5B5B5B]">Call for Buy</span>
                <Toggle
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-2 border-gray-300">
                ...
                <Dropdown
                  width={"240px"}
                  height={"36px"}
                  items={["Akahliya", "NoyaShorok", "Dhaka"]}
              ...
              <div className="border-b-[2px] w-full border-gray-300">
                <div className="w-full flex justify-between items-center px-[23px] py-3 ">
                  <div className="flex flex-col">
                    <span className="text-[16px] text-[#5B5B5B] my-1 flex">
                      Eligible services
                      <Tooltip
                        position="top"
                        content="Select the items that are eligible to be redeemed
                        by customers as part of the membership. They 
                        can only redeem these items."
                      >
                        <RiErrorWarningLine className="text-xs text-[#1A535B] -mt-[7px] -ml-[4px]" />
                      </Tooltip>
                    </span>
              ...
              <div className="w-full flex justify-between items-center px-[23px] py-3 border-b-2 border-gray-300">
                <p className="text-[16px] text-[#5B5B5B] flex">
                  ...
                  <Tooltip
                    position="top"
                    content="Set up whether and when a patient may cancel this 
                    membership. Manual cancellation of a membership 
                    is always possible by a practitioner or staff member."
                  >
                    <RiErrorWarningLine className="text-xs text-[#1A535B] -mt-[7px] -ml-[4px]" />
                  </Tooltip>
                </p>
                <Dropdown
                  width={"240px"}
                  height={"36px"}
                  items={["Cancellable anytime", "Not Cancellable", "1 Week", "2 Week", "1 Month", "2 Month", "3 Month", "8 Month", "1 Years", "2 Years", "3 Years"]}
                  selected={"Cancellable anytime"}
                  onSelected={(selected) => {
                    onChangeValue({
                      target: {
                        name: "Cancellable anytime",
                        value: selected,
                      },
                    });
                  }}
